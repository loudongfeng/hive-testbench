...
runcommand "beeline -i settings/load-flat.sql -f ddl-tpcds/text/alltables.sql --hivevar DB=tpcds_text_${SCALE} --hivevar LOCATION=${DIR}/${SCALE}"
...
do
	...
	COMMAND="beeline -i settings/load-partitioned.sql -f ddl-tpcds/bin_partitioned/${t}.sql \
